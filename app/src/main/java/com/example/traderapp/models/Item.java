...
public class Item {
    ...
    @Expose
    private Double pLMarketPrice;
    @SerializedName("SortOrder")
    @Expose
    private Integer sortOrder;

    public Item (String symbol, Double qtyT2, Double lastPx){
        setSymbol(symbol);
        setQtyT2(qtyT2);
        setLastPx(lastPx);
    }
    ...
    public void setExFields2(String exFields2) {
        this.exFields2 = exFields2;
    }

    public Double getPLMarketPrice() {
        return pLMarketPrice;
    }

    public void setPLMarketPrice(Double pLMarketPrice) {
        this.pLMarketPrice = pLMarketPrice;
    }
